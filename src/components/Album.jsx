export default function Album({album, cart, addToCart}){  //props es una palabra reservada para pasarle como argumento los props. Extraigo el album y tambien la funcion del carrito setCart
